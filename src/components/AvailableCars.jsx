  ...
  return (
   <>
    ...
    <div className=" border grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 mx-auto">
      {carsData.filter((car => car.availabilityStatus.toLowerCase() === "available")).map((car) => (
        <div key={car._id} className="w-full mx-auto max-w-sm bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-5 shadow-2xl relative tracking-wide">
                ...
                <div className="grid grid-cols-3 gap-2 py-4 border-t border-b border-white/5 my-5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-slate-300">{car.pickupLocation}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 border-l border-white/5 pl-2">
                    ...
                    <span className="text-[11px] text-slate-300">{car.seatCapacity} Seats</span>
                  </div>
